...
const translations = {
  zh: {
    ...
    burmese: "မြန်မာ",
    burmeseDesc: "မြန်မာဘာသာဖြင့် စမ်းသပ်ပါ",
    startTest: "开始测试",
  ...
  my: {
    ...
    chinese: "တရုတ်",
    chineseDesc: "တရုတ်ဘာသာဖြင့် စမ်းသပ်ပါ",
    english: "အင်္ဂလိပ်",
    englishDesc: "အင်္ဂလိပ်ဘာသာဖြင့် စမ်းသပ်ပါ",
    burmese: "မြန်မာ",
    burmeseDesc: "မြန်မာဘာသာဖြင့် စမ်းသပ်ပါ",
    startTest: "စမ်းသပ်မှုစတင်ရန်",
    languageDisclaimer:
      "စမ်းသပ်မှုအတွင်း မည်သည့်အချိန်တွင်မဆို ဘာသာစကားပြောင်းနိုင်ပါသည်",

    // 欢迎页面
    findYourScent: "သင့်အတွက်သီးသန့်ရနံ့ကိုရှာဖွေပါ",
    welcomeText:
    ...
    questionText2: "",
    scoreTitle: "လက်ရှိရနံ့ဖြန့်ဝေမှု",
    ...
    // 香调描述
    citrusDesc:
      "သင်သည် လန်းဆန်းပြီး စွမ်းအားပြည့်ဝသော ရနံ့များကို နှစ်သက်ပါသည်။ နေ့စဉ်လန်းဆန်းစေရန်၊ နေရောင်ခြည်၏စွမ်းအားပြည့်ဝမှုရှိသော ရနံ့များကို သဘောကျပါသည်။",
    fruityDesc:
      "သင်သည် ချိုမြိန်ပြီး ချစ်စရာကောင်းသော ရနံ့များကို ပိုမိုနှစ်သက်ပါသည်။ လူတွေကိုပိုမိုနီးစေလိုသော စွမ်းအားပြည့်ဝသော ရနံ့များဖြစ်ပါသည်။",
    aquaticDesc:
    ...
    greenDesc:
      "သင်သည် သဘာဝကျပြီး ပေါ့ပါးသော ရနံ့များကို နှစ်သက်ပါသည်။ ဘဝနှင့်နီးစပ်ပြီး လူတွေကို သက်တောင့်သက်သာခံစားရစေသော ရနံ့များဖြစ်ပါသည်။",
    orientalDesc:
      "သင်သည် လျှို့ဝှက်ဆန်းကြယ်ပြီး ထူးခြားသော ရနံ့များကို စွဲမက်ပါသည်။ အားကောင်းသောလူစွမ်းအားနှင့် ဆန်းကြယ်သောဆွဲဆောင်မှုရှိသော ရနံ့များဖြစ်ပါသည်။",
    woodyDesc:
      "သင်သည် နွေးထွေးပြီး ယုံကြည်စိတ်ချရသော ရနံ့များကို နှစ်သက်ပါသည်။ တည်ငြိမ်ပြီး စိတ်ချရမှုကို ပေးစွမ်းသော ရနံ့များဖြစ်ပါသည်။",
    floralDesc:
      "သင်သည် နူးညံ့ပြီး ချစ်ခြင်းမေတ္တာပြည့်ဝသော ရနံ့များကို နှစ်သက်ပါသည်။ သိမ်မွေ့ပြီး စွဲမက်ဖွယ်ကောင်းသော၊ အမျိုးသမီးဆန်သော ဆွဲဆောင်မှုရှိသော ရနံ့များဖြစ်ပါသည်။",
  ...
  my: [
    {
      ...
      options: [
        ...
        {
          text: "ခေတ်ဟောင်း လက်ဖက်ရည်ဆိုင်။ (စန္ဒကူးနံ့နဲ့ ဟင်းခတ် အမွှေးအကြိုင်အနံ့တွေပြည့်နေတဲ့ နေရာ)။",
          category: "东方调",
          icon: "🎭",
        },
        {
          text: "ရှေးခေတ်ပုံစံ စာကြည့်တိုက်။ (သစ်သားအနံ့ မွှေးနေတဲ့ စာအုပ်စင်တွေ ရှိတဲ့နေရာ)။",
          category: "木质调",
          icon: "🌲",
        },
        {
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: "ချစ်ခင်မြတ်နိုးစရာ အပြည့်နဲ့ ချစ်စရာကောင်းတဲ့သူ။",
          category: "果香调",
          icon: "🍑",
        },
        {
          text: "တည်ငြိမ်ပြီး ကျိုးကြောင်းဆင်ခြင် နိုင်စွမ်း အပြည့်ရှိသူ။",
          category: "水生调",
          icon: "🌊",
        },
        {
          text: "ပေါ့ပါး သွက်လက်ပြီး သက်သောင့်သက်သာ နေထိုင်သူ။",
          category: "绿叶调",
          icon: "🍃",
        },
        {
        ...
        {
          text: "နူးညံ့ သိမ်မွေ့ပြီး စာနာစိတ် အပြည့်ရှိသူ။",
          category: "花香调",
          icon: "🌹",
        },
      ],
    ...
    {
      id: "quiz4",
      text: "သင့်ကို အောက်ပါ တွဲစပ်မှုက ပိုပြီး စွဲဆောင်နေပါသလဲ။",
      options: [
    ...
    {
      id: "quiz5",
      text: "ပါတီပွဲ တခုမှာ သင့်အသွင်ကို ဘယ်လို ရေမွှေး ရနံ့မျိုးနဲ့ ဖော်ပြချင်ပါသလဲ။",
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "ဥရောပဒေသတွေရဲ့ လန်းဆန်း သန့်စင်တဲ့ ပင်လယ်ရေရနံ့။", category: "水生调", icon: "🌊" },
    ...
    {
      id: "quiz7",
      text: "ရေမွှေးအသစ် ရွေးချယ်ရာမှာ ဘယ်လိုအရာက သင့်ကို အရင်ဆုံး ဆွဲဆောင်နိုင်ပါသလဲ။",
      options: [
        { text: "ပထမဆုံး ဖြန်းလိုက်တာနဲ့ လန်းဆန်းပြီး စိတ်ကို သက်ဝင်လှုပ်ရှားစေတဲ့ ရနံ့", category: "柑橘调", icon: "🍊" },
        { text: "ချိုမြိန်ပေမယ့် မအီနေဘဲ အနံ့ရတာနဲ့ စိတ်ကိုပျော်သွား စေတဲ့ ရနံ့။", category: "果香调", icon: "🍑" },
        { text: "အေးစက်ပြီး တည်ကြည်တဲ့ အပြင် ချဉ်းကပ်ရခက်စေမယ့် အသွင်မျိုးနဲ့ ရနံ့။", category: "水生调", icon: "🌊" },
    ...
    {
      id: "quiz8",
      text: "အောက်ပါ ဘဝဖြတ်သန်းပုံ မြင်ကွင်းများထဲတွင် မည်သည့် ရနံ့နှင့် သင်လိုက်ဖက်ညီသည်ဟု ခံစားရပါသလဲ။",
      options: [
        { text: "မနက်ခင်းမှာ စိတ်ကြည်လင်စေပြီး စိတ်ကို နိုးကြားစေမယ့် ရနံ့။", category: "柑橘调", icon: "🍊" },
        { text: "သူငယ်ချင်းတွေနဲ့ အတူ ကိတ်မုန့်ဆိုင်မှာ သွားလည်နေသလို ချိုမြိန်တဲ့ ရနံ့။", category: "果香调", icon: "🍑" },
        ...
        { text: "လူကြီးသူမများနှင့် စကားပြောချိန်တွင် တည်ငြိမ်သော အသွင်ကို ဆောင်စေသော ရနံ့။", category: "木质调", icon: "🌲" },
        { text: "ချစ်သူနှင့် Dateချိန်တွင် နွေးထွေးချိုမြိန်သော ရနံ့။", category: "花香调", icon: "🌹" },
      ],
    },
    {
      id: "quiz9",
      text: "မည်သည့် ရနံ့ပုံစံကို သင် မနှစ်သက်ပါသလဲ။",
      options: [
        ...
        { text: "ပူနွေး အီဆိမ့်ပြီး အသက်ရှူလို့မကောင်းတဲ့ ရနံ့။", category: "水生调", icon: "🌊" },
        ...
        { text: "လေးနက် တည်ကြည်မှု မရှိဘဲ တိမ်လို လေလို လွင့်မျောနေတဲ့ ရနံ့။", category: "木质调", icon: "🌲" },
        { text: "နူးညံ့မှု မရှိဘဲ စူးရှ ပြင်းထန်လွန်းသော ရနံ့။", category: "花香调", icon: "🌹" },
      ],
    },
    {
      id: "quiz10",
      text: "တနှစ်ပတ်လုံး အသုံးပြုနိုင်မည့် ရနံ့ကို ရွေးချယ်ရာတွင် မည်သည့် ရနံ့ကို သင်ပိုမို တန်ဖိုးထားပါသလဲ။",
      options: [
        { text: "တနှစ်ပတ်လုံး အသုံးပြုဖို့ ကိုက်ညီပြီး ရာသီမရွေး စိတ်လန်းဆန်းစေသော ရနံ့။", category: "柑橘调", icon: "🍊" },
        { text: "သင့်လျော်တဲ့ ချိုမြိန်မှုနဲ့ တနှစ်ပတ်လုံး စိတ်ပျော်ရွှင်စေတဲ့ ရနံ့။", category: "果香调", icon: "🍑" },
        ...
        { text: "နွေးထွေး တည်ငြိမ်ပြီး ဥတု သုံးပါးလုံး သုံးနိုင်မယ့် ရနံ့။", category: "木质调", icon: "🌲" },
        { text: "ပွဲတော်တိုင်းအတွက် သင့်လျော်စေမယ့် နူးညံ့ ညင်သာတဲ့ ရနံ့။", category: "花香调", icon: "🌹" },
      ],
    },
  ],
};
...
const categories = {
  柑橘调: {
    ...
    description: {
      ...
      my: "လန်းဆန်းပြီး စွမ်းအားပြည့်ဝ၊ နေ့စဉ်လန်းဆန်းစေရန်သင့်တော်",
    },
    personality: { zh: "阳光活力型", en: "Sunshine Energy Type", my: "နေရောင်ခြည်စွမ်းအားပြည့်ဝအမျိုးအစား" },
    detailedDesc: {
      ...
      my: "သင်သည် လန်းဆန်းပြီး စွမ်းအားပြည့်ဝသော ရနံ့များကို နှစ်သက်ပါသည်။ နေ့စဉ်လန်းဆန်းစေရန်၊ နေရောင်ခြည်၏စွမ်းအားပြည့်ဝမှုရှိသော ရနံ့များကို သဘောကျပါသည်။",
    },
    recommendedScents: {
      zh: ["柠檬", "柚子", "佛手柑", "橙", "葡萄柚"],
  ...
  果香调: {
    ...
    description: {
      ...
      my: "ချိုမြိန်ပြီး ချစ်စရာကောင်း၊ ဆွဲဆောင်မှုပြည့်ဝ",
    },
    ...
    detailedDesc: {
      ...
      my: "သင်သည် ချိုမြိန်ပြီး ချစ်စရာကောင်းသော ရနံ့များကို ပိုမိုနှစ်သက်ပါသည်။ လူတွေကိုပိုမိုနီးစေလိုသော စွမ်းအားပြည့်ဝသော ရနံ့များဖြစ်ပါသည်။",
    },
    recommendedScents: {
      zh: ["桃子", "苹果", "莓果", "荔枝", "芒果"],
  ...
  绿叶调: {
    ...
    description: {
      ...
      my: "သဘာဝကျပြီး ပေါ့ပါး၊ ဘဝနှင့်နီးစပ်",
    },
    ...
    detailedDesc: {
      ...
      my: "သင်သည် သဘာဝကျပြီး ပေါ့ပါးသော ရနံ့များကို နှစ်သက်ပါသည်။ ဘဝနှင့်နီးစပ်ပြီး လူတွေကို သက်တောင့်သက်သာခံစားရစေသော ရနံ့များဖြစ်ပါသည်။",
    },
    recommendedScents: {
      zh: ["青草", "茶叶", "薄荷", "罗勒", "无花果叶"],
  ...
  东方调: {
    ...
    detailedDesc: {
      ...
      my: "သင်သည် လျှို့ဝှက်ဆန်းကြယ်ပြီး ထူးခြားသော ရနံ့များကို စွဲမက်ပါသည်။ အားကောင်းသောလူစွမ်းအားနှင့် ဆန်းကြယ်သောဆွဲဆောင်မှုရှိသော ရနံ့များဖြစ်ပါသည်။",
    },
    recommendedScents: {
      zh: ["琥珀", "麝香", "香草", "肉桂", "乳香"],
  ...
  花香调: {
    ...
    description: {
      ...
      my: "နူးညံ့ပြီး ချစ်ခြင်းမေတ္တာပြည့်ဝ၊ သိမ်မွေ့ပြီး စွဲမက်ဖွယ်",
    },
    personality: { zh: "温柔浪漫型", en: "Gentle Romantic Type", my: "နူးညံ့ချစ်ခြင်းမေတ္တာပြည့်ဝအမျိုးအစား" },
    detailedDesc: {
      zh: "你偏好温柔浪漫的香气，细腻动人，富有女性魅力。",
      en: "You prefer gentle and romantic fragrances, delicate and moving, with feminine charm.",
      my: "သင်သည် နူးညံ့ပြီး ချစ်ခြင်းမေတ္တာပြည့်ဝသော ရနံ့များကို နှစ်သက်ပါသည်။ သိမ်မွေ့ပြီး စွဲမက်ဖွယ်ကောင်းသော၊ အမျိုးသမီးဆန်သော ဆွဲဆောင်မှုရှိသော ရနံ့များဖြစ်ပါသည်။",
    },
    recommendedScents: {
      zh: ["玫瑰", "茉莉", "百合", "铃兰", "紫罗兰"],
    ...
    bestFor: {
      ...
      my: ["ချိန်းတွေ့ခြင်း", "ချစ်ခြင်းမေတ္တာပြည့်ဝသောအခမ်းအနားများ", "နွေဦးရာသီ", "အမျိုးသမီးအခမ်းအနားများ"],
    },
  },
};
    ...
    my: [
      {
        ...
        options: ["TikTok", "Facebook", "WeChat", "သူငယ်ချင်းထံမှ တဆင့်", "ဖြတ်သွားဖြတ်လာခြင်းမှ တဆင့်", "အခြား"],
      },
      {
        id: "q2",
    ...
    return {
      ...
      detailedDesc:
        currentLanguage === "zh"
          ...
          : "သင်သည် ရနံ့များအတွက် ထူးခြားသောအမြင်နှင့် နှစ်သက်မှုများရှိပါသည်။",
      recommendedScents: [],
      bestFor: [],
      // 添加图片路径
